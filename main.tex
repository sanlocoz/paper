...
Research flowchart used in this study can be seen in figure \ref{fig: flowchart}. Research will be carried out to determine the structure's response to variations in tsunami loads. The main building parameters used are described in sub-chapter 3.3. The criteria for building acceptance of the tsunami load to be used are in sub-chapter 3.8. The following are brief steps of the research to be carried out.
...
\node (dec1) [decision, below of=pro5, yshift=-0.5cm] {Are the structure accepted?};
